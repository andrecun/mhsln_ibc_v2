...
//exit();
    ...
    public function prosesEkstension($kode)
    {

        $query = "INSERT INTO `mahasiswa`(`namamahasiswa`, `namamahasiswa2`, `email`,
              `tempatlahir`, `tanggallahir`, `alamat`, `city`, `province`, `country`, `postal`, `alamatind`,
              `cityind`, `provinceind`, `postalind`, `telp`, `telp2`, `nmrpaspor`, `mulaipassport`,
              `akhirpassport`, `mulaibelajar`,  `nationality_idnationality`,
              `universitas_iduniversitas`, `prodi_idprodi`, `jurusan_idjurusan`,
                `jenjangstudi_idjenjangstudi`, `user_iduser`,
                `sex`,`tgl_update`, `ekstension`,`kode_asal`)
                select `namamahasiswa`, `namamahasiswa2`, `email`,
              `tempatlahir`, `tanggallahir`, `alamat`, `city`, `province`, `country`, `postal`, `alamatind`,
              `cityind`, `provinceind`, `postalind`, `telp`, `telp2`, `nmrpaspor`, `mulaipassport`,
              `akhirpassport`, `mulaibelajar`,  `nationality_idnationality`,
              `universitas_iduniversitas`, `prodi_idprodi`, `jurusan_idjurusan`,
                `jenjangstudi_idjenjangstudi`, `user_iduser`,
                `sex`,Now() , 1,`kode` from mahasiswa where kode='$kode';
                  ";
        $result = $this->query($query);
        // ambil query hasil insert
        $query = "select * from mahasiswa where kode_asal='$kode'";
        $result = $this->query($query);
