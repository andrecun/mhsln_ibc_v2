  ...
  ?>
          <div class="col-md-9 te-content te-col-md-9">
              ...
              <div class="panel panel-default">
                ...
                <div class="panel-heading te-panel-heading"><i class="glyphicon glyphicon-th-list"></i> <p>List of Level of Study</p>
                      <a href="add-period-study.html" class="btn btn-primary btn-xs te-pull-right">Add New</a>
                </div>
                ...
                <table class="table table-striped table-bordered dataTable no-footer" role="grid" id="te_table" cellspacing="0" width="100%">
                  <thead>
                    <tr>
                      <th>Level of Study Name</th>
                      <th>Long Period Permit(Month)</th>
                      <th>Action</th>
                    </tr>
                  </thead>
                  <tbody>
