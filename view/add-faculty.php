                    ...
                    <div class="col-md-9 te-content te-col-md-9">
                         <div class="panel panel-default">
                              ...
                              <div class="panel-heading te-panel-heading">
                                   <i class="glyphicon glyphicon-th-large"></i> <p>Add Faculty Information</p>
                              </div>
                              ...
                              <div class="panel-body">
                                   <form class="form-horizontal" role="form">
                                        ...
                                        <div class="form-group">
                                             <label for="inputFakultas" class="col-md-3 control-label">Nama Fakultas</label>
                                             <div class="col-md-9">
                                                  <input type="text" class="form-control" id="inputFakultas" placeholder="Nama Fakultas">
                                             </div>
                                        </div>
                                        <div class="form-group">
