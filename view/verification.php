                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div id="pt_asal_div" style="display:<?= $display_prodi ?>">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input disabled type="text" class="form-control" id="pt_asal" value="<?= $pt_asal ?>" name="pt_asal" placeholder="">
                                                </div>
                                                <div class="col-md-3">
                                            <input  type="checkbox" <?php
                                        ...
                                        <div id="content_tambahan" style="display:<?php if ($jenjangstudi_idjenjangstudi <= 7) echo "none";
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input  disabled type="text" class="form-control" id="penyelenggara_program" value="<?= $penyelenggara_program ?>" name="penyelenggara_program" placeholder="">
                                                </div>
                                                <div class="col-md-3">
                                            <input  type="checkbox" <?php
                                            ...
                                            <div class="form-group">
                                                <label for="inputPostalCode" class="col-md-3 control-label">Lokasi/Keterangan Program</label>
                                                <div class="col-md-6">
                                                    <input disabled type="text" class="form-control" id="ket_program" value="<?= $ket_program ?>" name="ket_program" placeholder="">
                                                </div>
                                                <div class="col-md-3">
                                            <input  type="checkbox" <?php
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    ...
                                                    <input disabled type="text" readonly="1" class="form-control" id="mulaibelajar" value="<?= $mulaibelajar ?>" name="mulaibelajar" placeholder="Start of Study">
                                                    <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    <input disabled type="text" readonly="1"  class="form-control" id="periode_belajar_start" value="<?= $periode_belajar_start ?>" name="periode_belajar_start" placeholder="From">
                                                    <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-group">
                                                    <input disabled type="text"  readonly="1"  class="form-control" id="periode_belajar_end" value="<?= $periode_belajar_end ?>" name="periode_belajar_end" placeholder="To">
                                                    <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group ">
                                                       ...
                                                       <div class="col-md-6">
                                                            <input disabled type="text" value="<?= $jml_kitas?>" class="form-control" id="jml_kitas" name="jml_kitas" placeholder="Jumlah Kitas">
                                                       </div>
                                                       <div class="col-md-3">
