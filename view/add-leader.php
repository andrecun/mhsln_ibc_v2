                    ...
                    <div class="col-md-9 te-content te-col-md-9">
                         <div class="panel panel-default">
                              ...
                              <div class="panel-heading te-panel-heading">
                                   <i class="glyphicon glyphicon-th-large"></i> <p>Add Leader Information</p>
                              </div>
                              ...
                              <div class="panel-body">
                                   <form class="form-horizontal" role="form">
                                        <div class="form-group has-error">
                                             <label for="inputNIP" class="col-md-3 control-label">NIP</label>
                                             <div class="col-md-9">
                                                  <input type="text" class="form-control" id="inputNIP" name="NIP" placeholder="NIP">
                                             </div>
                                        </div>
                                        <div class="form-group">
                                             <label for="inputNamaPim" class="col-md-3 control-label">Nama Pimpinan</label>
                                             <div class="col-md-9">
                                                  <input type="text" class="form-control" id="inputNamaPim" placeholder="Nama Pimpinan">
                                             </div>
                                        </div>
                                        <div class="form-group">
