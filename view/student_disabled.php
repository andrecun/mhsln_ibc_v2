                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group ">
                                            ...
                                            <div class="col-md-9">
                                                <select disabled="1"class="form-control" id="inputStatus" name="status">
...
?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <textarea disabled="1"  rows="10" cols="50" type="keterangan"  class="form-control" id="keterangan" value="<?php echo trim( $keterangan ) ?>" name="keterangan" placeholder="Information"><?php echo $keterangan ?></textarea>
                                            </div>
                                        </div>
