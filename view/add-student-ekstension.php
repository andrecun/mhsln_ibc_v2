...
<div class="container">
    ...
    <div class="row te-container te-row">
        ...
        if ($jData > 0) {
            ...
            $tgl_skld = $UTILITY->format_tanggal($data["tglskld"]);
        ...
        <div class="col-md-9 te-content te-col-md-9">
            ...
            <ul class="nav nav-tabs" id="teTab" role="tablist">
                <li class="active">
                    <a href="#personal_info" role="tab" data-toggle="tab">
                        <span class="badge">1</span> Informasi Identitas <i
            ...
            <div id="teTabContent" class="tab-content">
                ...
                <div class="tab-pane fade in active" id="personal_info">
                    ...
                    <form class="form-horizontal" role="form" id="frmMode1" enctype="multipart/form-data" method="post"
                          action="<?= $url_rewrite ?>proses/ekstension/">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-group ">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" value="<?= $namamahasiswa ?>"
                                               id="namamahasiswa" name="namamahasiswa" placeholder="">
                                    </div>
                                </div>
                                <!-- <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="inputPlaceDateBirth" class="col-md-3 control-label">Tempat/Tanggal Lahir
                                        *</label>
                                    <div class="col-md-9">
                                        <div class="col-md-5 te-no-padding">
                                            <input type="text" class="form-control" id="tempatlahir"
                                                   value="<?= $tempatlahir ?>" name="tempatlahir" placeholder="">
                                        </div>
                                        <div class="col-md-1">
                                            <label for="inputPlaceDateBirth"
                                                   class="col-md-3 control-label te-no-padding">/</label>
                                        </div>
                                        <div class="col-md-6 te-no-padding">
                                            ...
                                            <div class="input-group">
                                                <input type="text" readonly="1" class="form-control" id="tanggallahir"
                                                       value="<?= $tanggallahir ?>" name="tanggallahir" placeholder="">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" name="nationality_idnationality"
                                                id="nationality_idnationality">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <label for="inputProvince" class="col-md-3 control-label">Provinisi/Negara Bagian
                                        *</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="province" name="province"
                                               value="<?= $province ?>" placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="postal" value="<?= $postal ?>"
                                               name="postal" placeholder="">
                                    </div>
                                </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading te-panel-heading">
                                <i class="glyphicon glyphicon-th-large"></i>
                                <p>Tempat Tinggal di Indonesia (*: wajib)</p>
                            </div>
                            ...
                            <div class="panel-body">
                                <div class="form-group ">
                                    <label for="inputCurrentAddress" class="col-md-3 control-label">Alamat Terkini
                                        *</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="alamatind" value="<?= $alamatind ?>"
                                               name="alamatind" placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="inputCity" class="col-md-3 control-label">Kota *</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="cityind" value="<?= $cityind ?>"
                                               name="cityind" placeholder="">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="inputProvince" class="col-md-3 control-label">Provinsi/Negara Bagian
                                        *</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="provinceid"
                                               value="<?= $provinceid ?>" name="provinceid" placeholder="">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="inputPostalCode" class="col-md-3 control-label">Kode Pos *</label>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="postalind" value="<?= $postalind ?>"
                                               name="postalind" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        if ($foto != "") {
                                            ...
                                            ?>
                                            <input type="file" class="form-control" id="foto" name="foto"> <i>Max Size
                                                : <?= $CONFIG->sizeFile_text ?></i>
                                            <?php
                                        }
                                        ?>
                                    </div>
                ...
                <div class="tab-pane fade" id="study_info">
                    ...
                    <form class="form-horizontal" role="form" id="frmMode2" name="frmMode2"
                          enctype="multipart/form-data" method="post" action="<?= $url_rewrite ?>proses/ekstension/">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-group ">
                                    ...
                                    <div class="col-md-9">
                                        <select onchange="tampilkanProdi();" class="form-control"
                                                name="universitas_iduniversitas" id="universitas_iduniversitas">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="inputPeriod" class="col-md-3 control-label">Program/Jenjang
                                        Studi</label>
                                    <div class="col-md-9">
                                        <select onchange="showDiv();" class="form-control"
                                                name="jenjangstudi_idjenjangstudi" id="jenjangstudi_idjenjangstudi">
                                ...
                                <div class="form-group" id='mou-div' style="display: <?= $status_display_mou ?>">
                                    <label for="inputMOU" class="col-md-3 control-label">Dok.
                                        Kerjasama(MOU/MOA) <?= dok_mou ?></label>
                                    <div class="col-md-9">
                                        <?php
                                        if ($dok_mou != "") {
                                            ...
                                            ?>
                                            <input type="file" class="form-control" id="dok_mou" name="dok_mou">  <i>Tipe
                                                File: jpg/png/pdf <b>Max Size : <?= $CONFIG->sizeFile_text ?></b></i>
                                ...
                                <div id="pt_asal-div" style="display:<?= $status_display_pt_asal ?>">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="pt_asal" value="<?= $pt_asal ?>"
                                                   name="pt_asal" placeholder="">
                                        </div>
                                    </div>
                                    <!--<div class="form-group">
                                ...
                                <div id="content_keterangan" style="display: <?= $status_display_ket ?>">
                                    <div class="form-group">
                                        <label for="inputPostalCode" class="col-md-3 control-label">Penyelenggara
                                            Program </label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="penyelenggara_program"
                                                   value="<?= $penyelenggara_program ?>" name="penyelenggara_program"
                                                   placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputPostalCode" class="col-md-3 control-label">Lokasi/Keterangan
                                            Program</label>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="ket_program"
                                                   value="<?= $ket_program ?>" name="ket_program" placeholder="">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading te-panel-heading">
                                <i class="glyphicon glyphicon-th-large"></i>
                                <p>Pengajuan Periode Ijin Belajar</p>
                            </div>
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            <input type="text" readonly="1" class="form-control" id="mulaibelajar"
                                                   value="<?= $mulaibelajar ?>" name="mulaibelajar" placeholder="">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <select class="form-control" name="lamaijin" id="lamaijin"
                                                onchange="lama_ijin();">
                                            <?php
                                            if ($lamaijin == "3 Bulan")
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            <input type="text" readonly="1" class="form-control"
                                                   ...
                                                   name="periode_belajar_start" placeholder="">
                                            <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            <input type="text" readonly="1" class="form-control"
                                                   ...
                                                   name="periode_belajar_end" placeholder="">
                                            <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="tab-pane fade" id="supporting_document">
                    <form class="form-horizontal" role="form" name="frmMode3" id="frmMode3"
                          enctype="multipart/form-data" method="post" action="<?= $url_rewrite ?>proses/ekstension/">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" value="<?= $nmrpaspor ?>" class="form-control" id="nmrpaspor"
                                               name="nmrpaspor" placeholder="">
                                    </div>
                                </div>
                                <script>
                                    $(function () {
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            <input type="text" readonly="1" class="form-control" id="mulaipassport"
                                                   value="<?= $mulaipassport ?>" name="mulaipassport" placeholder="">
                                            <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            <input type="text" readonly="1" class="form-control" id="akhirpassport"
                                                   value="<?= $akhirpassport ?>" name="akhirpassport" placeholder="">
                                            <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="inputEnclosurePassport" class="col-md-3 control-label">Scan
                                        Paspor</label>
                                    <div class="col-md-9">
                                        <?php
                                        if ($passport1 != "") {
                                            ...
                                            ?>
                                            <input type="file" class="form-control" id="passport1" name="passport1"><i>Tipe
                                                File: jpg/png/pdf Max Size : <?= $CONFIG->sizeFile_text ?></i>
                                            <?php
                                        }
                                        ?>
                                    </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-heading te-panel-heading">
                                <i class="glyphicon glyphicon-th-large"></i>
                                <p>Dokumen Pendukung (Penjamin,Pendanaan, KITAS, Surat Keterangan,Transkrip,dll)</p>
                            </div>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <label for="inputScholarshipProvider" class="col-md-3 control-label">Penyedia
                                        Beasiswa</label>
                                    <div class="col-md-9">
                                        <input type="text" value="<?= $sumber_pembiayaan ?>" class="form-control"
                                               id="sumber_pembiayaan" name="sumber_pembiayaan"
                                               placeholder="Scholarship Provider">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputScholarshipProvider" class="col-md-3 control-label">Jabatan
                                        Penjamin</label>
                                    <div class="col-md-9">
                                        <input type="text" value="<?= $jabatan_penjamin ?>" class="form-control"
                                               id="jabatan_penjamin" name="jabatan_penjamin" placeholder=""><i>Misalnya:
                                            Rektor, Direktur, Ketua Prodi</i>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputFinancialStatement" class="col-md-3 control-label">Surat
                                        Keuangan</label>
                                    <div class="col-md-9">
                                        <?php
                                        if ($keuangan != "") {
                                            ...
                                            ?>
                                            <input type="file" class="form-control" id="keuangan" name="keuangan"><i>Tipe
                                                File: jpg/png/pdf Max Size : <?= $CONFIG->sizeFile_text ?></i>
                                        <?php }
                                        ?>
                                    </div>
                                ...
                                <div class="form-group">
                                    <label for="inputStatementLetter" class="col-md-3 control-label">Surat
                                        Pernyataan</label>
                                    <div class="col-md-9">
                                        <?php
                                        if ($pernyataan1 != "") {
                                            ...
                                            <i>Tipe File: jpg/png/pdf Max Size : <?= $CONFIG->sizeFile_text ?></i>
                                            <?php
                                        }
                                        ?>
                                    </div>
                                ...
                                <div class="form-group">
                                    <label for="inputMedicalStatement" class="col-md-3 control-label">Surat
                                        Kesehatan</label>
                                    <div class="col-md-9">
                                        <?php
                                        if ($kesehatan != "") {
                                            ...
                                            ?>
                                            <input type="file" class="form-control" id="kesehatan" name="kesehatan"><i>Tipe
                                                File: jpg/png/pdf Max Size : <?= $CONFIG->sizeFile_text ?></i>
                                            <?php
                                        }
                                        ?>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" value="<?= $no_kitas ?>" class="form-control" id="no_kitas"
                                               name="no_kitas" placeholder="Nomor Kitas">
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <label for="inputNumber" class="col-md-3 control-label">Jumlah Kitas</label>
                                    <div class="col-md-9">
                                        <input type="text" value="<?= $jml_kitas ?>" class="form-control" id="jml_kitas"
                                               name="jml_kitas" placeholder="Jumlah Kitas">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        if ($kitas != "") {
                                            ...
                                            ?>
                                            <input type="file" class="form-control" id="kitas" name="kitas"><i>Tipe
                                                File: jpg/png/pdf Max Size : <?= $CONFIG->sizeFile_text ?></i>
                                            <?php
                                        }
                                        ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="input-group">
                                            <input type="text" readonly="1" class="form-control" id="tgl_kitas"
                                                   value="<?= $tgl_kitas ?>" name="tgl_kitas" placeholder="Tgl KITAS">
                                            <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="input-group">
                                            <input type="text" readonly="1" class="form-control" id="tgl_kitas_akhir"
                                                   value="<?= $tgl_kitas_akhir ?>" name="tgl_kitas_akhir"
                                                   placeholder="Tgl KITAS Berakhir">
                                            <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="inputLetterAcceptance" class="col-md-3 control-label">Transkrip
                                        Akademik</label>
                                    <div class="col-md-9">
                                        <?php
                                        if ($ijazah != "") {
                                            ...
                                            ?>
                                            <input type="file" class="form-control" id="ijazah" name="ijazah"><i>Tipe
                                                File: jpg/png/pdf Max Size : <?= $CONFIG->sizeFile_text ?></i>
                                            <?php
                                        }
                                        ?>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" value="<?= $no_skld ?>" class="form-control" id="no_skld"
                                               name="no_skld" placeholder="Nomor Kitas">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputLetterAcceptance"
                                           class="col-md-3 control-label">SKLD/SKJ/STM</label>
                                    <div class="col-md-9">
                                        <?php
                                        if ($skld != "") {
                                            ...
                                            ?>
                                            <input type="file" class="form-control" id="skld" name="skld"><i>Tipe File:
                                                jpg/png/pdf Max Size : <?= $CONFIG->sizeFile_text ?></i>
                                            <?php
                                        }
                                        ?>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <div class="input-group">
                                            <input type="text" readonly="1" class="form-control" id="tgl_skld"
                                                   value="<?= $tgl_skld ?>" name="tgl_skld" placeholder="Tgl SKLD">
                                            <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-group " style="display:none">
                                    <label for="inputLoginUsername" class="col-md-3 control-label">Desired Login
                                        Username</label>
                                    <div class="col-md-9">
                                        <input type="text" readonly="1" class="form-control" id="idmahasiswa"
                                               value="<?= $login_mahasiswa ?>" name="idmahasiswa"
                                ...
                                <div class="form-group" style="display:none">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <input type="hidden" value="<?= $universitas_iduniversitas ?>"
                                               name="universitas_iduniversitas"/>
                                        <input type="hidden" value="account" name="kondisi"/>
                                        <input type="password" readonly="1" class="form-control" id="login_password"
                                               value="<?= $login_mahasiswa ?>" name="login_password"
                                               placeholder="Choose a Password">
                                    </div>
                                </div>
                                <center>Silahkan Klik Tombol Verfikasi untuk memasukan atau memperbaharui LOR (Letter of
                                    Reccomendation)
                                </center>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <textarea rows="30" cols="50" type="keterangan" class="form-control" id="keterangan"
                                              disabled="1" value="<?= $keterangan ?>" name="keterangan"
                                              placeholder="Information"><?= $keterangan ?></textarea>
                                </div>
                            </div>

                            <?php if ($status_ijin == 4) { ?>
                                <div class="form-group">
                                    <label for="inputPassword" class="col-md-3 control-label">Cetak Berkas
                                        Persetujuan</label>
                                    <div class="col-md-9">
