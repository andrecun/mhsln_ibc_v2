    ...
    <div class="row te-container te-row">
        ...
        <div class="col-md-9 te-content te-col-md-9">
            <div class="jumbotron">
                ...
                ?>
                <form role="form te-form-filter" method="post" action="<?= $url_rewrite ?>ch/report">
                        ...
                        <div class="row">
                            ...
                            <!--<div class="col-md-4 te-padding-top">
                                <select class="form-control" id="inputStatus" name="status">
                                    <?php
/*                                    $qry = $DB->query("select idstatus,namastatus from status where idstatus='3' ");
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 te-padding-top">
                                <div class="input-group">
                                    <input type="text" readonly="1" class="form-control" id="periode_belajar_start"
                                           value="<?= $periode_belajar_start ?>" name="periode_belajar_start"
                                           placeholder="Tanggal Awal Report">
                            ...
                            <div class="col-md-4 te-padding-top">
                                <div class="input-group">
                                    <input type="text" readonly="1" class="form-control" id="periode_belajar_end"
                                           value="<?= $periode_belajar_end ?>" name="periode_belajar_end"
                                           placeholder="Tanggal Akhir Report">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    ?>
                    <a href="<?= $url_rewrite ?>ch/report/dashboard_report/<?= $par_keyword ?>/<?= $par_status ?>/<?= $kodeUniversitas ?>/<?= $par_country ?>/<?= trim($periode_belajar_start) ?>/<?= trim($periode_belajar_end) ?>"
