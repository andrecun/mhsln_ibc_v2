...
if ($kondisi == "keterangan") {
   ...
   $DB->query("update ijin set tgl_update='$tgl_update', status_idstatus='$status', keterangan='$keterangan',keterangan_field='$keterangan_field' where mahasiswa_idmahasiswa='$mahasiswa_idmahasiswa' ");
